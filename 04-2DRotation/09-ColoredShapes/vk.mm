...
NSString *gszWindowTitle = @"macOS: Two Colored Shapes - Vulkan";
...
- (VkResult) createDescriptorPool {
    ...
    vkDescriptorPoolSize.descriptorCount = 2; // one uniform buffer per descriptor set (triangle + rectangle)
    ...
    vkDescriptorPoolCreateInfo.maxSets = 4; // two descriptor sets: triangle and rectangle
