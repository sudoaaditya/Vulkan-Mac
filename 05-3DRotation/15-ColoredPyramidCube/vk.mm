...
- (VkResult) createVertexBuffer {
    ...
    if(bFoundMatchingMemoryType_vertex == VK_FALSE) {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(fptr, "createVertexBuffer(): Failed to find suitable memory type for Vertex Buffer for Pyramid Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): Suitable memory type found for Vertex Buffer for Pyramid Position!.\n");
    }
    ...
    if(bFoundMatchingMemoryType_vertex == VK_FALSE) {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(fptr, "createVertexBuffer(): Failed to find suitable memory type for Vertex Buffer for Pyramid Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): Suitable memory type found for Vertex Buffer for Pyramid Color!.\n");
    }
    ...
    if(bFoundMatchingMemoryType_vertex == VK_FALSE) {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(fptr, "createVertexBuffer(): Failed to find suitable memory type for Vertex Buffer for Cube Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): Suitable memory type found for Vertex Buffer for Cube Position!.\n");
    }
    ...
    if(bFoundMatchingMemoryType_vertex == VK_FALSE) {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(fptr, "createVertexBuffer(): Failed to find suitable memory type for Vertex Buffer for Cube Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): Suitable memory type found for Vertex Buffer for Cube Color!.\n");
    }
...
- (VkResult) createDescriptorPool {
    ...
    vkDescriptorPoolSize.descriptorCount = 2; // we have only one uniform buffer
    ...
    vkDescriptorPoolCreateInfo.maxSets = 2; // we have only one descriptor set
