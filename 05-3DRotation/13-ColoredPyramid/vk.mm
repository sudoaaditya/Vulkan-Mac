...
NSString *gszWindowTitle = @"macOS: Colored Pyramid - Vulkan";
...
- (VkResult) createVertexBuffer {
    ...
    if(bFoundMatchingMemoryType_vertex == VK_FALSE) {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(fptr, "createVertexBuffer(): Failed to find suitable memory type for Vertex Buffer for Position!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): Suitable memory type found for Vertex Buffer for Position!.\n");
    }
    ...
    if(bFoundMatchingMemoryType_vertex == VK_FALSE) {
        vkResult = VK_ERROR_OUT_OF_DEVICE_MEMORY;
        fprintf(fptr, "createVertexBuffer(): Failed to find suitable memory type for Vertex Buffer for Color!.\n");
        return (vkResult);
    } else {
        fprintf(fptr, "createVertexBuffer(): Suitable memory type found for Vertex Buffer for color!.\n");
    }
